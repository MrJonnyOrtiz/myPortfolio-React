export default function PrivacyPolicy() {
  return (
    <div className="container mx-auto p-4">
      ...
      <p className="mb-4">Last Updated: September 27, 2024</p>

      <h2 className="mb-2 text-2xl font-semibold">Introduction</h2>
      <p className="mb-4">
        Welcome to Jonny Ortiz Portfolio. We are committed to protecting your
        personal information and respecting your privacy. This Privacy Policy
        explains how we collect, use, and safeguard your information when you
        visit our website jonnyortiz.com and interact with our services. By
      ...
      <p className="mb-4">
        ...
        including when you visit our website, fill out forms, or interact with
        other activities, services, or resources on our site. The information we
        may collect includes:
      </p>
      <ul className="mb-4 list-inside list-disc">
        <li>
          <strong>Personal Identification Information:</strong> Name, email
          address, phone number, etc., when voluntarily submitted by you.
        </li>
        <li>
          <strong>Non-Personal Information:</strong> Information such as browser
          type, device type, IP address, and usage data.
        </li>
        <li>
      ...
      <p className="mb-4">
        ...
        decline the use of third-party cookies, including those used by Google
        Analytics. When you first visit our website, you will be prompted to
        select which cookies you consent to use through our cookie consent
        banner.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        usage and improve the user experience. The information is shared with
        Google in an aggregated, anonymized format, and Google may use this
      ...
      <p className="mb-4">
        ...
        no internet transmission is completely secure, we strive to use
      ...
      <p className="mb-4">
        ...
        practices or for other operational, legal, or regulatory reasons. When
        we make changes, we will update the &quot;Last Updated&quot; date at the
        top of this policy. Please review this Privacy Policy regularly to stay
      ...
      <p className="mb-4">
        Jonny Ortiz
        <br />
        Powered by Cloud Realm <br />
        jonnyortiz@cloudrealmllc.com
      </p>
    </div>
  );
}
